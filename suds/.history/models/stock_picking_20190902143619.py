...
class DeliveryAnalyticAccount(models.Model):
    ...
    analytic_account_id = fields.Many2one('account.analytic.account', string="Analytic Account", readonly=False, compute="_get_analytic_account")
    ...
    def _get_analytic_account(self):
        for i in self:
            ...
            if i.picking_type_code =='incoming':
                i.account_analytic_id = stock_source_incoming.analytic_account_id.id
