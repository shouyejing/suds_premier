...
class DeliveryAnalyticAccount(models.Model):
    ...
    def _get_analytic_account(self):
        for i in self:
            ...
            _logger.info("/n/n/n/n res %s /n/n/n/n" % (i.picking_type_code))

            if i.picking_type_code == 'incoming':
                i.analytic_account_id = stock_source_incoming.account_analytic_id.id
            
            elif i.picking_type_code == 'outgoing':
                i.analytic_account_id = stock_source_outgoing.analytic_account_id.id
