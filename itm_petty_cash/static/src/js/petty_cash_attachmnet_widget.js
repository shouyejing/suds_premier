 ...
 */
odoo.define('itm_petty_cash.petty_cash_attachmnet_widget', function (require) {
"use strict";
...
var PettyCashShowAttachmnetWidget = AbstractField.extend({
	cssLibs: [
...
field_registry.add('petty_cash_attachmnet', PettyCashShowAttachmnetWidget);
